package com.darly.darlyview.wedget.slidinguppanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Default height of the drawable_shapeloading_shadow above the peeking out panel
     */
    ...
    /**
     * Drawable used to draw the drawable_shapeloading_shadow between panes.
     */
    ...
    /**
     * The size of the drawable_shapeloading_shadow in pixels.
     */
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        // If the drawable_shapeloading_shadow height is zero, don't show the drawable_shapeloading_shadow
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
    ...
    /**
     * @return The current drawable_shapeloading_shadow height
     */
    ...
    /**
     * Set the drawable_shapeloading_shadow height
     *
     * @param val A height in pixels
     */
    ...
    public void draw(Canvas c) {
        ...
        // draw the drawable_shapeloading_shadow
