...
import com.darly.darlyview.wedget.lottie.animation.content.KeyPathElementContent;
import com.darly.darlyview.wedget.lottie.model.CubicCurveData;
  ...
  public static void getPathFromData(ShapeData shapeData, Path outPath) {
    ...
    for (int i = 0; i < shapeData.getCurves().size(); i++) {
      ...
      if (cp1.equals(currentPoint) && cp2.equals(vertex)) {
        ...
        // https://github.com.darly.darlyview.wedget/lottie-android/issues/275
        //
